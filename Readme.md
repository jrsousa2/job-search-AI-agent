...
for postings to include some of my hard skills. Each in-scope job posting is assigned a binary score (keywords that correspond to the 1s are displayed next to the score in the HTML lists -- it makes it easy to debug when issues arise and is very useful for development).
