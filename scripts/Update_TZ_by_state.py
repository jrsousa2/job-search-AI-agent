# UPDATES THE TIME ZONE OF THE JOB POSTINGS BASED ON STATE AND CITY NAMES
# IT'S A CASCADING PROCESS, WHERE ET STATES COME FIRST, THEN CT, MT AND PT
# IT'S NOT SUPER ADVANCED, BUT IT'S PRETTY USEFUL
